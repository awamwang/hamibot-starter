 ...
 * @Description: 全局异常类
 */
import { Record, getStackTrace, TraceCollectionType, TraceStackFrameType, LoggerSchemes } from './logger'
...
export class ConfigInvalidException extends ValueException {
  ...
  constructor(fieldName: string, helpInfo?: string) {
    super(`The '${fieldName}' field in the configuration is invalid${', ' + helpInfo}. ` + 'please check it again !')
  }
}
